...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#openClueModel").click(function () {
			//获取到所有者
			$.ajax({
				url:"clue/listUser.do",
				type:"get",
				success:function (resp) {
					...
					$("#create-owner option[value='${user.id}']").prop("selected", true);
		...
		$("#createBtn").click(function () {
			$.ajax({
				...
				success:function (resp) {
					if(resp){
						listClue(1 ,$("#cluePage").bs_pagination('getOption', 'rowsPerPage'));
	...
	//显示线索
	function listClue(pageNo, pageSize) {
		$.ajax({
			url:"clue/search.do",
			data:{
				pageNo:pageNo,
			...
			success:function (resp) {
				var html = "";
				$.each(resp.clues, function (index, item) {
					html += '<tr>';
					html += '<td><input type="checkbox" /></td>';
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'clue/detail.do?id='+item.id+'\';">'+item.fullname+item.appellation+'</a></td>';
				...
				$("#cluePage").bs_pagination({
					...
					onChangePage : function(event, data){
						listClue(data.currentPage , data.rowsPerPage);
					}
				});
			}
		});
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-call">
								  <option></option>
								  <c:forEach items="${appellationList}" var="ch">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" id="openClueModel"><span class="glyphicon glyphicon-plus"></span> 创建</button>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover" id="clueListTable">
					<thead>
